...
var stripe = Stripe('pk_test_51JhW30IRI51oHvBegEtSsTTFSzhcipHPvTmKlWmQ7NfoaDHdgMFES8YXPTPgM7igT7tROYqzVEXmmMR5mMhS3MBO00QgOCguLk');
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('sign-up-confirm-password').value;
